...
class FoursquareApi
{
    ...
    public function  __construct($client_id = false, $client_secret = false, $redirect_uri = '', $version = 'v2',
        $language = 'en', $api_version = DEFAULT_VERSION)
    {
     ...
     * @param Array|bool $params A set of parameters to be appended to the request, defaults to false (none)
     *
     * @return mixed
     */
     ...
     *
     * @param Array|bool $requests An array of arrays containing the endpoint and a set of parameters
     ...
     * @param Array|bool $params The parameters to pass to the request
     * @param string $type
     *
     * @return mixed
     */
